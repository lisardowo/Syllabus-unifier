...
Navigate to the HackPad directory:
...
Using the Application
    ...
    Upload one or more syllabus PDF files
    Optionally specify a semester start date for schedule generation
    Click the generate button
    Download the generated unified syllabus PDF and/or calendar .ics file
